            ...
            <div class="modal-content">
                ...
                <form action="login.php" method="POST">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="usuario" id="usuario_login" aria-describedby="emailHelp" placeholder="Ingresa tu usuario">
                    </div>
                    <div class="form-group">
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <form action="register.php" method="POST" onsubmit="return validation()">
                    ...
                    <div class="form-group">
                        <label for="usuario">Usuario</label>
                        <input type="text" class="form-control" name="usuario_registrar" id="usuario_registrar" aria-describedby="emailHelp" placeholder="Ingresa tu usuario">
                    </div>
                    <div class="form-group">
                        <label for="password">Contraseña</label>
